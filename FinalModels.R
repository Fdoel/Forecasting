...
# SETAR models
SETAR <- arx.ls_T(inflation_df_monthly$inflationNonSA, NULL, 2, 0.6,1) # SETAR using grid search
SETAR_x <- arx.ls_T(inflation_df_monthly$inflationNonSA, NULL, 2, 0.3 ,1) # SETAR-X using grid search

# STAR models
STAR <- arx.ls_ST(inflation_df_monthly$inflationNonSA, NULL, 2, 0.6,1,1) # STAR using grid search
STAR_x <- arx.ls_ST(inflation_df_monthly$inflationNonSA, NULL, 2, 0.3 ,1,1) # STAR-X using grid search
